...
public class menuKategori extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtSub = new Palette.JTextfieldRounded();
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/ktegory.png"))); // NOI18N
        jLabel6.setText("jLabel5");

        Judul.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        Judul.setForeground(new java.awt.Color(255, 255, 255));
        Judul.setText("Tambah Data Kategori");
                ...
                .addGroup(pn_addLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pn_addLayout.createSequentialGroup()
                        ...
                        .addGroup(pn_addLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtkategori, javax.swing.GroupLayout.DEFAULT_SIZE, 1095, Short.MAX_VALUE)
                            .addGroup(pn_addLayout.createSequentialGroup()
                                .addGroup(pn_addLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(pn_addLayout.createSequentialGroup()
                            ...
                            .addComponent(txtSub, javax.swing.GroupLayout.DEFAULT_SIZE, 1095, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pn_addLayout.createSequentialGroup()
                        .addContainerGap()
    ...
    private Palette.JTextfieldRounded txtSub;
    ...
    private String setIdKategori() {
        ...
        String sql = "SELECT RIGHT(Id_Kategori, 3) AS Nomor "
            + "FROM kategori "  // Pastikan ada spasi setelah nama tabel
            + "WHERE Id_Kategori LIKE 'KTG_%' "
    ...
    private void insertData() {
        ...
        String  namaKategori = txtkategori.getText();
        String  subKategori = txtSub.getText();


        if (idKategori.isEmpty() || namaKategori.isEmpty()|| subKategori.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Semua Kolom Harus Diisi!", "Validasi", JOptionPane.ERROR_MESSAGE);
            return; // penting agar proses tidak lanjut
        }
        try {
             String sql = "INSERT INTO kategori (Id_Kategori, Nama_Kategori, Jenis) VALUES (?, ?, ?)";
            try (PreparedStatement st = conn.prepareStatement(sql)){
                st.setString(1, idKategori);
                st.setString(2, namaKategori);
                st.setString(3, subKategori);
    ...
    private void dataTabel() {
        ...
        Judul.setText("Perbaru Data Kategori");
        
        txtID.setEnabled(false);
        
        txtID.setText(tblData.getValueAt(row, 0).toString());
        txtkategori.setText(tblData.getValueAt(row, 1).toString());
        txtSub.setText(tblData.getValueAt(row, 2).toString());
    }
